...
-- Servicos
INSERT INTO services (name, price, duration_min, active, sort_order) VALUES
('Corte (sobrancelha cortesia)', 43.00, 60, true, 1),
('Corte + Barbaterapia (sobrancelha cortesia)', 75.00, 80, true, 2),
('Barbaterapia (pezinho cortesia)', 43.00, 60, true, 3),
('Orelha e Nariz com cera', 25.00, 30, true, 4),
('Selagem', 50.00, 60, true, 5);
